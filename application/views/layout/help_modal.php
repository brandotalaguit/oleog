      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="col-md-12">
                <p>4. To finalize the grades, click the <button class="btn btn-primary">SAVE FINAL DATA</button> button. This will be  considered final and <strong class="text-primary">CANNOT</strong> be <strong  class="text-primary">EDITED</strong> without filling an Amendment at the Registrar’s Office. Make sure everything is in order before saving.</p>
          ...
          <div class="col-md-6">
              ...
              <table class="table table-bordered" style="text-align: center;">
                <tr>
                  <td colspan="3" class="text-center"><b>REVISED GRADING SYSTEM</b></td>
                </tr>
                <tr>
                  <td class="text-center"><b>GRADE</b></td>
                  <td class="text-center"><b>PERCENTAGE EQUIVALENT</b></td>
                  <td class="text-center"><b>ADJECTIVAL EQUIVALENT</b></td>
                </tr>
                <tr>
                  <td>1.00</td>
                  <td>97-100 %</td>
