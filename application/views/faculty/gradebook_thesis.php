				...
				<div class="table-responsive">
					...
					?>
									...
									<tr>
										...
										<td width="5%">
											<button type="button" class="btn btn-default btn-sm btnModalThesisTitle" 
											  data-toggle="modal" data-target=".modalThesisTitle" 
											  id="btn<?php echo $ctr ?>"
											  data-uri="<?php echo base_url('gradebook/get_thesis_title') ?>"
											  data-remote="<?php echo base_url('gradebook/thesis_title') ?>"> 
											  Thesis Title
											</button>
										</td>
										<td width="15%">
...
<!-- thesis dialog -->
<div class="modal fade modalThesisTitle" tabindex="-1" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
