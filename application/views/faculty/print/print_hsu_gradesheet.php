			...
			<div class="row">
				<div class="col-xs-12">
					<div class="text-center">
						...
						<h5><b class="printhide"></b><b><?php echo $schedule->CollegeDesc;?></b></h5>
						<br>
					</div>
					<table class="info table table-condensed">
						<tbody>
							...
							<tr>
								<td width=""></td>
								<td colspan="4"><h5><b class="printhide"><?php echo $schedule->SemDesc . ', A.Y. ' . $schedule->SyDesc; ?></b></b></h5></td>
								<td width=""><h5><b class="printhide tdspace">Yr & Sec: </b><b><?php echo $schedule->year_section;?></b></h5></td>
								<!-- <td width="" align="right">&nbsp;</td> -->
							</tr>
						</tbody>
					</table>
