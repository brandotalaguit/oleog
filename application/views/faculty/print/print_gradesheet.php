...
<?php for ($page=1; $page <= $report['pages'] ; $page++) : ?>
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="text-center">
						...
						<h5><b class="printhide">College of </b><b><?php echo $schedule->CollegeDesc;?></b></h5>
						<br>
					</div>
					<table class="info table table-condensed">
						<tbody>
							...
							<tr>
								...
								<td width=""><b class="printhide"><h5><b class="printhide">Units: </b><b><?php echo $schedule->Units;?></b></h5></b></td>
							</tr>
							<!-- <tr>
								<td width="">&nbsp;</td>
								<td colspan="2">&nbsp;</td>
							...
							<tr>
								<td width=""></td>
								<td colspan="4"><h5><b class="printhide"><?php echo $schedule->SemDesc . ', A.Y. ' . $schedule->SyDesc; ?></b></h5></td>
								<td width=""><h5><b class="printhide tdspace">Yr & Sec: </b><b><?php echo $schedule->Year . '-' . $schedule->Section;?></b></h5></td>
								<!-- <td width="" align="right">&nbsp;</td> -->
							</tr>
						</tbody>
					</table>
			...
			<div><hr></div>
					<h5><b>NOTE: INDICATE WHEN STUDENT DROPPED</b></h5>
					<p class="">
						<span class="col-xs-1 text-right"><b><?php echo $report['total_row']; ?></b></span> <strong>TOTAL NO. OF STUDENTS REGISTERED</strong><br>
						<span class="col-xs-1 text-right"><b><?php echo $report['cnt_passed']; ?></b></span> <strong>TOTAL NO. OF STUDENTS WITH GRADES OF 3.0 OR BETTER<strong></strong><br>
						<span class="col-xs-1 text-right"><b><?php echo $report['cnt_od']; ?></b></span><strong> TOTAL NO. OF STUDENTS WHO DROPPED OFFICIALLY BEFORE END OF SEM.</strong><br>
						<span class="col-xs-1 text-right"><b><?php echo $report['cnt_ud']; ?></b></span> <strong>TOTAL NO. OF STUDENTS WHO DROPPED UNOFFICIALLY BEFORE END OF SEM.</strong><br>
						<span class="col-xs-1 text-right"><b><?php echo $report['cnt_inc']; ?></b></span> <strong>TOTAL NO. OF STUDENTS WITH INCOMPLETE GRADES</strong><br>
						<span class="col-xs-1 text-right"><b><?php echo $report['cnt_failed']; ?></b></span><strong> TOTAL NO. OF FAILURES</strong><br>
					</p>
				</div>
				...
				<div class="col-xs-4 text-center">
					<?php echo date_convert_to_php(date('Y-m-d H:i:s'), "M d, Y H:i:s"); ?><br>
					<p class="underline">
						<b>Printed Date</b>
					</p>
				</div>
			...
			<p class="pull-right lead">( THIS SERVES AS YOUR DRAFT COPY )</p>
