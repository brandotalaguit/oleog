...
<?php echo anchor('site/stat/summary', 'College Encoding of Grades Statistics', array('class' => 'btn-link hidden-print', 'target' => '_blank')); ?>
<div class="row">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				...
				<p>
				<?php echo anchor('site/hsu_stat/late_encode', 'View Late Encoding', array('class' => 'btn-link label label-primary hidden-print', 'target' => '_blank')); ?> 
				<?php echo anchor('site/hsu_stat/on_time_encode', 'View On-Time Encoding', array('class' => 'btn-link label label-primary hidden-print', 'target' => '_blank')); ?>
				<?php echo anchor('site/hsu_stat/not_encoded', 'View Not Yet Encoded', array('class' => 'btn-link label label-primary hidden-print', 'target' => '_blank')); ?>
				<?php echo anchor('site/hsu_stat/download', 'Download Encoding Stat', array('class' => 'btn-link label label-primary hidden-print', 'target' => '_blank')); ?>
				<?php echo anchor('site/hsu_stat/download_data', 'Download Data', array('class' => 'btn-link label label-primary hidden-print', 'target' => '_blank')); ?>
				</p>
			</div>
		</div>
	</div>
...
<div class="panel panel-default">
	...
	<div class="panel-heading">
	<h3><?php echo $college->CollegeDesc ?><br><small>(<?php echo $college->CollegeCode ?>)</small></h3>
	</div>
	<!-- Table -->
	<table class="table table-bordered table-condensed table-responsive">
			<thead>
				<tr>
					...
					<th colspan="3">Graded</th>
					<th colspan="3">Not Graded</th>
					<th rowspan="2">No. of Load</th>
				</tr>
				<tr>
					<th>On-Time</th>
					<th>Late</th>
					<th>TOTAL</th>
					<th><small>Waiting to save</small></th>
			...
			<?php foreach ($college_stat as $value): ?>
				...
				<tr>
					...
					<td data-toggle="tooltip" title="On-Time Encoding" data-container="body" class="text-success">
					<?php echo anchor("site/hsu_stat/{$faculty_id}/on_time_encode", $value->on_time, $attr);  ?>
					</td>
					<td data-toggle="tooltip" title="Late Encoding" data-container="body" class="text-danger">
					<?php echo anchor("site/hsu_stat/{$faculty_id}/late_encode", $value->late, $attr);  ?>
					</td>
					<th  data-toggle="tooltip" title="Graded" data-container="body" class="text-center">
					<?php echo $value->on_time + $value->late ?>
						
					</th>
					<td  data-toggle="tooltip" title="Waiting to save" data-container="body" class="text-info">
					<?php echo $value->waiting_to_save ?>
						
					</td>
					<td  data-toggle="tooltip" title="Not yet graded" data-container="body" class="text-danger">
					<?php echo $value->not_yet_graded ?>
						
					</td>
					<th data-toggle="tooltip" title="Not Graded" data-container="body" >
					<?php echo $value->waiting_to_save + $value->not_yet_graded ?>
						
					</th>
					<td data-toggle="tooltip" title="Total" data-container="body" >
			...
			<tfoot>
				<tr>
					...
					<th><small>Waiting to save</small>: <?php echo $cnt_pending; ?></th>
